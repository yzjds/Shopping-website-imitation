...
export default {
  ...
  // 这里监视，是监视不到数据变化的，因为数据早都过来了（3-3不会变化）
  // 而listContainer是可以监视到数据变化的（0-4变化）
  /* watch: {
    floor: {
      immediate: true,//无论有没有检测导数据变化，都立即执行一次回调函数
